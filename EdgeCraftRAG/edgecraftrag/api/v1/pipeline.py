...
@register_microservice(
    name="opea_service@ec_rag", endpoint="/v1/settings/pipelines", host="0.0.0.0", port=16010, methods=["GET"]
)
...
# GET Pipeline
@register_microservice(
    name="opea_service@ec_rag", endpoint="/v1/settings/pipelines/{name}", host="0.0.0.0", port=16010, methods=["GET"]
)
...
# POST Pipeline
@register_microservice(
    name="opea_service@ec_rag", endpoint="/v1/settings/pipelines", host="0.0.0.0", port=16010, methods=["POST"]
)
...
# PATCH Pipeline
@register_microservice(
    name="opea_service@ec_rag", endpoint="/v1/settings/pipelines/{name}", host="0.0.0.0", port=16010, methods=["PATCH"]
)

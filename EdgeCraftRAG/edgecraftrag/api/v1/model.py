...
# GET Models
@register_microservice(name="opea_service@ec_rag", endpoint="/v1/settings/models", host="0.0.0.0", port=16010, methods=['GET'])
...
# POST Model
@register_microservice(name="opea_service@ec_rag", endpoint="/v1/settings/models", host="0.0.0.0", port=16010, methods=['POST'])
...
# PATCH Model
@register_microservice(name="opea_service@ec_rag", endpoint="/v1/settings/models/{model_id:path}", host="0.0.0.0", port=16010, methods=['PATCH'])
async def update_model(model_id, request: ModelIn):
    # The process of patch model is : 1.delete mdoel 2.create model
...
# DELETE Model
@register_microservice(name="opea_service@ec_rag", endpoint="/v1/settings/models/{model_id:path}", host="0.0.0.0", port=16010, methods=['DELETE'])

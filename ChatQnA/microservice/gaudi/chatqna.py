...
class ChatQnAService:
    ...
    def add_remote_service(self):
        embedding = RemoteMicroService(name="embedding", host="10.7.4.144", port=6000, expose_endpoint="/v1/embeddings")
        retriever = RemoteMicroService(name="retriever", host="10.7.4.144", port=7000, expose_endpoint="/v1/retrieval")
        rerank = RemoteMicroService(name="rerank", host="10.7.4.144", port=8000, expose_endpoint="/v1/reranking")
        llm = RemoteMicroService(name="llm", host="10.7.4.144", port=9000, expose_endpoint="/v1/chat/completions")

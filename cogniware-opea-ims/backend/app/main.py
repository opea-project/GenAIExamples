...
# Mock user database
USERS = {
    "consumer@company.com": {"password": "password123", "role": "Consumer", "name": "Consumer User"},
    "inventory@company.com": {"password": "password123", "role": "Inventory Manager", "name": "Inventory Manager"},
    "admin@company.com": {"password": "password123", "role": "Super Admin", "name": "System Administrator"}
}
...
async def root():
    return {
        ...
        "capabilities": [
            "Embeddings", "Retrieval", "LLM", "DBQnA",
            "DocSummarization", "Interactive Agent", "Graph Generation",
            "Continuous Learning"
        ]
    }
...
async def chat(msg: ChatMessage):
    ...
    Uses RAG + DBQnA for intelligent responses
    """
...
async def upload_csv_knowledge(file: UploadFile = File(...)):
    """
    Upload CSV file to add to knowledge base
    Automatically processes and embeds data
    """
    try:
        # Read file content
...
async def upload_knowledge_file(file: UploadFile = File(...)):
    """
    Upload file (CSV, XLSX, PDF, DOCX) to knowledge base
...
async def retrain_knowledge_base():
    """
    Retrain entire knowledge base with latest embeddings
    Useful after adding bulk data
    """
...
async def get_dashboard_stats():
    ...
    return {
        ...
        "data": {
            ...
            "recent_activity": [
                {"type": "stock_update", "product": "Intel Xeon 6", "details": "San Jose • +50 units", "time": "2 mins ago"},
                {"type": "allocation", "product": "NVIDIA H100", "details": "Cloud Dynamics • 35 units", "time": "15 mins ago"},
                {"type": "alert", "product": "Warehouse", "details": "Portland at 82%", "time": "1 hour ago"},
            ]
        }
    }

# Example Translation deployments on an Intel® Xeon® Platform
...
- [Translation Quick Start Deployment](#translation-quick-start-deployment): Demonstrates how to quickly deploy a Translation application/pipeline on a Intel® Xeon® platform.
...
This section describes how to quickly deploy and test the Translation service manually on an Intel® Xeon® platform. The basic steps are:

...
function start_services() {
    ...
    list=("dataprep-vdms-server" "embedding-multimodal-server" "retriever-vdms-server" "reranking-videoqna-server" "lvm-video-llama" "lvm-video-llama" "videoqna-xeon-backend-server")

...
find . -type f \( -name "Dockerfile*" \) -print -exec hadolint --severity error,warn --ignore DL3006 --ignore DL3007 --ignore DL3008 --ignore DL3013 {} \; 2>&1 | tee ${log_dir}/hadolint.log

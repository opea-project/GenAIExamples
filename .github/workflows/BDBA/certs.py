...
TEST_URLS = ('https://bdba001.icloud.intel.com/api/status',
             'https://sast.intel.com/cxrestapi/projects')
...
def ssl_error(test_urls: Iterable[str] = TEST_URLS) -> bool:
    ...
    for test_url in test_urls:
        try:
            ...
            print(f'Warning, unable to connect to {test_url}: {exc}',
                  file=sys.stderr)

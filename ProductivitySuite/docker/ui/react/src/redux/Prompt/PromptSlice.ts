...
export const promptSelector = (state: RootState) =>
  state.promptReducer;
export default PromptSlice.reducer;


export const getPrompts = createAsyncThunkWrapper("prompts/getPrompts", async ({ promptText} : { promptText: string | null}, { getState }) => {
  // @ts-ignore

...
export const CHAT_QNA_URL = import.meta.env
  .VITE_BACKEND_SERVICE_ENDPOINT_CHATQNA;
export const CODE_GEN_URL = import.meta.env
...
export const KEYCLOAK_SERVICE_URL = import.meta.env
  .VITE_KEYCLOAK_SERVICE_ENDPOINT;

export const DATA_PREP_URL = import.meta.env.VITE_DATAPREP_SERVICE_ENDPOINT;
export const DATA_PREP_GET_URL = import.meta.env
  .VITE_DATAPREP_GET_FILE_ENDPOINT;
export const DATA_PREP_DELETE_URL = import.meta.env
  .VITE_DATAPREP_DELETE_FILE_ENDPOINT;

export const CHAT_HISTORY_CREATE = import.meta.env

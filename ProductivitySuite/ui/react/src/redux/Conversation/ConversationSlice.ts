...
import { Message, MessageRole, ConversationReducer, ConversationRequest, Conversation, Model, UseCase, CodeRequest, SummaryFaqRequest } from "./Conversation";
...
export const getConversationHistory = createAsyncThunkWrapper(
  ...
  async ({ user, conversationId }: { user: string; conversationId: string }, { }) => {
    ...
    store.dispatch(updatePromptSettings({
...
export const deleteConversations = createAsyncThunkWrapper(
  "conversation/deleteConversations",
  async ({ user, conversationIds, useCase }: { user: string; conversationIds: string[]; useCase: string }, { dispatch }) => {
...
export const deleteConversation = createAsyncThunkWrapper(
  "conversation/delete",
  async ({ user, conversationId, useCase }: { user: string; conversationId: string; useCase: string }, { dispatch }) => {

...
export const themeCreator = (mode: 'light' | 'dark') => {
    ...
    return createTheme({
        ...
        customStyles: {
            ...
            homeTitle: {
                background: mode === 'dark' ? '#fff' : `linear-gradient(271deg, #C398FA -56.85%, #7E6DBB 21.46%, ${deepPurple} 99.77%)`
            },
            homeButtons: {
                borderRadius: '25px',
            ...
            fileInput: {
                ...
                file: {
                    backgroundColor: mode === 'dark' ? 'rgba(255,255,255,0.1)' : 'rgba(255,255,255,0.7)', 
                }
            },
            actionButtons: {
                text: {
            ...
            dropDown: {
                '&:hover, &:focus': {
                    backgroundColor: mode === 'dark' ? 'rgba(0,0,0, 0.5)' : 'rgba(230, 232, 253, 0.50)',
                },
                '&.Mui-selected': {
                    backgroundColor: mode === 'dark' ? 'rgba(0,0,0, 1)' : 'rgba(230, 232, 253, 0.75)',
                },

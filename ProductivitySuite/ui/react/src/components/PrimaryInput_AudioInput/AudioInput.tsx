...
const AudioInput: React.FC<AudioInputProps> = ({ setSearchText }) => {
    ...
    const isSpeechRecognitionSupported = ("webkitSpeechRecognition" in window || "SpeechRecognition" in window) && window.isSecureContext;
    ...
    const handleMicClick = () => {
        ...
        if (!isListening) {
            ...
            recognition.onerror = (event: SpeechRecognitionErrorEvent) => {
                notify(`Speech recognition error:${event.error}`, NotificationSeverity.ERROR);
    ...
    const renderMic = () => {
        ...
        if (type === 'summary' || type === 'faq' || !isSpeechRecognitionSupported) return <></>;

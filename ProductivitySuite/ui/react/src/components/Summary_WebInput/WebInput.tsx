...
import { IconButton, InputAdornment, List, ListItem, ListItemText, styled, TextField, useTheme } from "@mui/material";
import { useState } from "react";
import styles from "./WebInput.module.scss";
import {Language} from '@mui/icons-material';

import { useAppDispatch, useAppSelector } from "@redux/store";
import { conversationSelector, setSourceLinks } from "@redux/Conversation/ConversationSlice";
        ...
        return (
            ...
            <List className={styles.dataList}>
                ...
                {sourceLinks.map((sourceItem: string, index:number) => (
                    ...
                    >
                        <ListItemText primary={ sourceItem.length > 30 ? `${sourceItem.substring(0, 27)}...` : sourceItem}/>
                        <Language />
                    </ListItem>
                ))}
            </List>

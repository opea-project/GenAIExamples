        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                gr.Examples(examples=[
                    ...
                    [f"{cur_dir}/resources/waterview.jpg", "What are the things I should be cautious about when I visit here?"],
...
if __name__ == "__main__":
    ...
    parser.add_argument("--worker-addr", type=str, default="http://localhost:8085", help="The worker address of the LLaVA server.")

...
function build_docker_images() {
    ...
    service_list="multimodalqna multimodalqna-ui embedding-multimodal-bridgetower embedding retriever-redis lvm lvm-llava-svc dataprep-multimodal-redis whisper"

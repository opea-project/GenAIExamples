...
2. Start services using the docker images built from source. See the [Gaudi Guide](./docker_compose/Intel/HPU/README.md) or [Xeon Guide](./docker_compose/Intel/CPU/README.md) for more information.
...
```bash
cd GenAIExamples/CodeGen/docker_compose/Intel/CPU
docker compose up -d
```
...
1. If you get errors like "Access Denied", [validate micro service](https://github.com/opea-project/GenAIExamples/tree/main/CodeGen/docker_compose/Intel/CPU#validate-microservices) first. A simple example:

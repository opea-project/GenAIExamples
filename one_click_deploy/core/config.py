...
EXAMPLE_CONFIGS = {
    "ChatQnA": {
        ...
        "ports": {
            "docker": {
                "backend": "8888", "dataprep": "11101", "embedding": "6000",
                "retriever": "7000", "reranking": "8000", "llm": "9009"
            },
            "k8s_services": {
                "backend": "chatqna-backend-server-svc", "dataprep": "dataprep-svc",
                "embedding": "embedding-mosec-svc", "retriever": "retriever-svc",
                "reranking": "reranking-mosec-svc", "llm": "llm-dependency-svc"
            }
        },
        "test_connections": {
            "main_service": {
                "service_key": "backend", "path": "/v1/chatqna", "method": "POST",
                "payload": {"messages": [{"role": "user", "content": "What is Nike's revenue?"}], "max_new_tokens": 100},
                "headers": {"Content-Type": "application/json"}, "expect_code": 200,
            },
            "sub_services": [{
                    "name": "llm_check", "service_key": "llm", "path": "/v1/chat/completions", "method": "POST",
                    ...
                    "headers": {"Content-Type": "application/json"}, "expect_code": 200, "expect_response_contains": "content"
            }]
        },
        "interactive_params": [
            {"name": "llm_model", "prompt": "LLM Model ID", "type": str, "default": "meta-llama/Meta-Llama-3-8B-Instruct", "help": "e.g., meta-llama/Meta-Llama-3-8B-Instruct"},
            {"name": "embed_model", "prompt": "Embedding Model ID", "type": str, "default": "BAAI/bge-base-en-v1.5", "help": "e.g., BAAI/bge-base-en-v1.5"},
            {"name": "rerank_model", "prompt": "Reranking Model ID", "type": str, "default": "BAAI/bge-reranker-base", "help": "e.g., BAAI/bge-reranker-base"},
            {"name": "mount_dir", "prompt": "Data Mount Directory (for Docker)", "type": str, "modes": ["docker"], "default": "./data"},
        ]
    },
    "CodeTrans": {
        "base_dir": "CodeTrans",
        ...
        "test_connections": {
            "main_service": {
                "service_key": "backend", "path": "/v1/codetrans", "method": "POST",
                "payload": {"source_code": "def hello():\n  print('world')", "source_lang": "python", "target_lang": "javascript"},
                "headers": {"Content-Type": "application/json"}, "expect_code": 200
            },
             "sub_services": [{
                    "name": "llm_code_trans_check", "service_key": "llm", "path": "/v1/completions", "method": "POST",
                    "payload_dynamic_llm_model": True, "default_llm_model_id_for_test": "codellama/CodeLlama-7b-instruct-hf",
